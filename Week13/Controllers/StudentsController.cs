...
namespace Week13.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "studentID,firstName,lastName,gpa")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "studentID,firstName,lastName,gpa")] Student student)
        {
            if (ModelState.IsValid)
            {
